...
int main()
{
    ...
    Shader cubeShader("./cubeVertexShader.vs", "./cubeFragmentShader_Spot.fs");
    ...
    pointLight pLight;
    pLight.position = glm::vec3(1.2, 0.75, 2);
    pLight.ambient = glm::vec3(0.2, 0.2, 0.2);
    pLight.diffuse = glm::vec3(1, 1, 1);
    pLight.specular = glm::vec3(1.5, 1.5, 1.5);
    pLight.constant = 1;
    pLight.linear = 0.22;
    pLight.quadratic = 0.20;

    dirLight dLight;
    dLight.direction = glm::vec3(-1, -0.25, -3);
    dLight.ambient = glm::vec3(0.2, 0.2, 0.2);
    ...
    sLight.innerCutoff = cos(glm::radians(12.5f));
    ...
    while (! glfwWindowShouldClose(window))
    {
        ...
        //cubeShader.setPointLightMaterialUniform("lMat", pLight);
        //cubeShader.setDirLightMaterialUniform("lMat", dLight);
        cubeShader.setSpotLightMaterialUniform("lMat", sLight);
